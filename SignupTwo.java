...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno) {
        ...
        religion.setBounds(300, 60, 400, 30);
        ...
        fname.setBounds(100, 100, 200, 30);
        add(fname);
        
        String valCategory[] = { "General", "OBC", "SC", "ST", "Other"};
        category = new JComboBox(valCategory);
        category.setBounds(300, 100, 400, 30);
        ...
        education.setBounds(300, 220, 400, 30);
        ...
        marital.setBounds(100, 260, 200, 30);
        add(marital);
        ...
        pan.setBounds(300, 300, 400, 30);
        add(pan);
        
        JLabel city = new JLabel("Aadhar Number:");
        city.setFont(new Font("Raleway", Font.BOLD, 20));
        city.setBounds(100, 340, 200, 30);
        add(city);
        ...
        syes.setBounds(300, 380, 100, 30);
        syes.setBackground(Color.WHITE);
        add(syes);
        
        sno = new JRadioButton("No");
        sno.setBounds(450, 380, 100, 30);
        ...
        pincode.setBounds(100, 420, 200, 30);
        add(pincode);
        
        eyes = new JRadioButton("Yes");
        eyes.setBounds(300, 420, 100, 30);
        eyes.setBackground(Color.WHITE);
        add(eyes);
        
        eno = new JRadioButton("No");
        eno.setBounds(450, 420, 100, 30);
